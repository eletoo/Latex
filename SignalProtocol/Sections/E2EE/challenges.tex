...
\begin{frame}{End-to-End Encryption}
    ...
    \begin{itemize}
        ...
        \item \textbf{Backdoors}: metodi per bypassare l'autenticazione standard o la protezione crittografica di un dispositivo. Se non volute, possono essere introdotte tramite attacchi cyber e poi sfruttate per violare la sicurezza del sistema
    \end{itemize}
